...
public class TwoPlayers extends javax.swing.JFrame {
    ...
    public TwoPlayers(String playerName){
     ...
     //Distributing cards to the AI players
      ...
      aiValue[0]=c13.getValue();
      aiValue[1]=c14.getValue();
      aiValue[2]=c15.getValue();
      aiValue[3]=c16.getValue();
    
      //Stroring hai suit
      aiSuit[0]=c13.getSuit();
      aiSuit[1]=c14.getSuit();
      aiSuit[2]=c15.getSuit();
      aiSuit[3]=c16.getSuit();
    ...
    {   
      ...
      //  int v=0;
        for(b=0; b<25; b++)
        {            
            if(mValue==aiValue[b] || mSuit==aiSuit[b])
            {
                    if(aiSuit[b]=="Spades")
                        sp=0;
                        ...
                        sp=3;
                    System.out.println("ai: "+(aiValue[b]));
                    System.out.println("ai: "+sp);
                   // v=aiValue[b];
                    Card ac = new Card(sp,aiValue[b]-1);
                    ...
                    if(check==25)
                    {
                        ...
                        AIWinnerScreen awin = new AIWinnerScreen(humanScore,name);
            ...
            else
            {
             ...
             System.out.println("pick v:"+aiValue[ai-1]);
             System.out.println("pick S:"+aiSuit[ai-1]);
        }
    }
    ...
    public void checkWinner()
    {
        ...
        if(check==25)
        {
            for(int h=0;h<25;h++)
            {
                if(aiValue[h]>0)
                {
                    aiScore=aiScore+aiValue[h];
                }
            }
                        
            WinnerScreen win = new WinnerScreen(aiScore,name);
            win.setVisible(true);
            dispose();
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(450, 220, 70, 100);
        ...
        jButton2.setBounds(320, 220, 70, 100);
        ...
        jLabel12.setBounds(290, 330, 180, 20);
        ...
        jButton16.setBounds(100, 270, 40, 30);
        ...
        jButton17.setBounds(150, 270, 40, 30);
        ...
        jButton18.setBounds(200, 270, 40, 30);
        ...
        jButton19.setBounds(250, 270, 40, 30);

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel13.setText("Super Power!!!! Nominate a suit ");
        jPanel1.add(jLabel13);
        jLabel13.setBounds(90, 230, 210, 30);
