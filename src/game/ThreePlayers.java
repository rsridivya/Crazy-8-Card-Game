...
public class ThreePlayers extends javax.swing.JFrame {
            ...
            if(mValue==aiValue1[b] || mSuit==aiSuit1[b])
            {
                   ...
                   // v=aiValue[b];
                    ...
                    if(check==25)
                    {
                        ...
                        flag = 1;
                        AIWinnerScreen11 awin11 = new AIWinnerScreen11(humanScore,aiScore2,name);
            ...
            if(mValue==aiValue2[b] || mSuit==aiSuit2[b])
            {
                   ...
                   // v=aiValue[b];
                    ...
                    if(check==25)
                    {
                        ...
                        flag =2;
                        AIWinnerScreen22 awin22 = new AIWinnerScreen22(humanScore,aiScore1,name);
    ...
    public void checkWinner()
    {
        ...
        if(check==25)
        {
            ...
            flag = 4;            
            WinnerScreen2 win2 = new WinnerScreen2(aiScore1,aiScore2,name);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(550, 220, 70, 100);
        ...
        jButton16.setBounds(340, 150, 40, 30);
        ...
        jButton17.setBounds(390, 150, 40, 30);
        ...
        jButton18.setBounds(440, 150, 40, 30);
        ...
        jButton19.setBounds(490, 150, 40, 30);

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel13.setText("Super Power!!!! Nominate a suit ");
        jPanel1.add(jLabel13);
        jLabel13.setBounds(340, 120, 210, 30);
        ...
        jLabel16.setBounds(800, 170, 90, 17);
